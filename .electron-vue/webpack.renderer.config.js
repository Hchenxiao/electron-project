    ...
    new webpack.DefinePlugin({
      ...
      'process.env':
        process.env.NODE_ENV === 'production'
          ? JSON.stringify(config.build.env)
          : JSON.stringify(config.dev.env),
...
// 将css相关得loader抽取出来
rendererConfig.module.rules = rendererConfig.module.rules.concat(
  styleLoaders({
    sourceMap:
      process.env.NODE_ENV !== 'production' ? config.dev.cssSourceMap : false,
    extract: IsWeb,
